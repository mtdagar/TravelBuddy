...
//----------------------------------------------------------------------------------------------------------
	...
	function addDraggableMarkers(map, behavior,start_0,end_0){

		var startmarker = new H.map.Marker(start_0, {icon: starticon});
	  startmarker.draggable = true;
	  map.addObject(startmarker);
	        
	  var endmarker = new H.map.Marker(end_0, {icon: endicon});
